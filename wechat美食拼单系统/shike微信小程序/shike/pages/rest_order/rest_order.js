...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'http://localhost:8080/rest_order/find', //仅为示例，并非真实的接口地址
      data: {
  ...
  wxSearchFn: function (e) {
    ...
    wx.request({
      url: 'http://localhost:8080/rest_order/searchOrder', //仅为示例，并非真实的接口地址
      data: {
  ...
  join: function (e) {
    var that = this
    wx.request({
      url: 'http://localhost:8080/user_order/add', //仅为示例，并非真实的接口地址
      data: {
        sum_number: e.target.dataset.sum_number,
