...
Page({
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (res.data.code == 1) {
          ...
          var my_date = res.data.data.date.substring(0,10)
          var my_time = res.data.data.date.substring(11,16)
          console.log(my_date)
          console.log(my_time)          
  ...
  formSubmit: function (e) {
    ...
    } else if (e.detail.value.caiName=""){
      that.setData({
        [caiName]: that.data.caiName
      })
    }
    ...
    } else if (e.detail.value.sum_number = "") {
      that.setData({
        [sum_number]: that.data.sum_number
      })
    }
    ...
    wx.request({
      ...
      data: {
        ...
        price:that.data.transmit.price,
